            ...
            <div className="max-w-4xl mx-auto p-8">
                <div className="space-y-6 text-justify">
                    <section>
                        ...
                        <p>
                            1.1. Сайт предоставляет Имениннику доступ к радости, веселью, поздравлениям, подаркам и не очень сложным загадкам.
                            <br />
                            1.2. Именинник обязуется быть довольным, не брюзжать и ценить сюрпризы, даже если это носки с ананасами.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            <br />
                            2.2. Именинник соглашается быть в отличном настроении и не жаловаться на отсутствие вертолёта в качестве подарка.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            3.1. Загадки несложные. Не пугайся. Это не ЕГЭ.
                            <br />
                    ...
                    <section>
                        ...
                        <p>
                            4.1. Сайт не несёт ответственности за внезапный смех, умиление и желание танцевать, но это не точно.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            5.1. Соглашение действует до конца праздника (или пока ты не ляжешь спать с улыбкой).
                            <br />
